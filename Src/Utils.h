...
enum class MATIKAKERNEL_API StatementType
{
...
enum class MATIKAKERNEL_API ExecutionSubType
{
	Multiply,
	DisplayTranspose,
...
enum class MATIKAKERNEL_API NumberType
{
	int_type,
	float_type,
	double_type,
